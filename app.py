...
# -------------------------------------------------------------
# 1. EXCLUSIVE ROUTER EXECUTION CONTROLLER
# -------------------------------------------------------------

# ROUTE A: LOGIN GATEWAY (Renders ONLY if completely logged out)
...
# ROUTE B: THE ADVANCED CONTROL CENTER (ADMINISTRATION PORTAL)
    ...
    with admin_tab[1]:
        ...
        # Performance optimization: If there is no active search query, only load the top 10 records
        if search_q == "":
...
# ROUTE C: STANDARD USER PROFILE DASHBOARD
else:
